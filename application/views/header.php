  ...
  $(document).ready(function(){
   ...
   /* var conProv = 1;
    $("#addProv").click(function(){
      conProv = conProv + 1;
      $(".proveedoresExtras").append('<div class="row"><div class="col" style="text-align: left; color: #ED1919;" id="DeletePro" tripRov='+conProv+'>'+conProv+')</div></div><div class="del-'+conProv+'"><div class="row"><div class="col-md-3 col-6"><label style="color: black;">Proveedor</label><br><input type="text"  class="form-control showData nameProveedor" placeholder="Proveedor.." name="proveedor['+conProv+'][pro_nombre]" required><div class="delayNameProveedor"></div><input type="text" hidden class="idProveedor" name="proveedor['+conProv+'][pro_id]"></div><div class="col-md-3 col-6"><label style="color: black;">Cod. Producto</label><br><input type="text"  class="form-control" placeholder="Cod. Producto.." name="compra['+conProv+'][com_codigoProducto]" required></div><div class="col-md-3 col-6"><label style="color: black;">Neto</label><br><input type="number"  class="form-control netoProveedor" placeholder="Neto.." name="compra['+conProv+'][com_neto]" required></div><div class="col-md-3 col-6"><label style="color: black;">Iva</label><br><input type="number"  class="form-control ivaProveedor" readonly placeholder="Iva.." name="compra['+conProv+'][com_iva]" required></div></div><br><div class="row"><div class="col-md-6 col-6"><label style="color: black;">Fac. Proveedor</label><br><input type="text"  class="form-control" placeholder="Fac. Proveedor.." name="compra['+conProv+'][com_numeroFactura]" required></div><div class="col-md-6 col-6"><label style="color: black;">% Recargo</label><br><input type="number"  class="form-control recargoProveedor" placeholder="% Recargo.." min="0" max="100" name="compra['+conProv+'][com_recargo]" required></div></div><br><div class="row"><div class="col-md-12 col-12" style="text-align: center;"><label style="color: black;">Forma de pago</label></div></div><br><div class="row"><div class="col-md-6 col-6"><label style="color: black;">Forma de pago</label><br><select class="form-control" name="formaPago['+conProv+'][for_tipo]" required><option value="0">Transferencia</option><option value="1">Cheque</option><option value="2">Efectivo</option></select></div><div class="col-md-6 col-6"><label style="color: black;">Abonos</label><br><input type="number"  class="form-control" placeholder="Abonos.." name="formaPago['+conProv+'][for_abono]" required></div></div><br><div class="row"><div class="col-md-6 col-6"><label style="color: black;">Fecha Doc.</label><br><input type="date"  class="form-control" placeholder="Fecha Documento.." name="formaPago['+conProv+'][for_fecha]" required></div><div class="col-md-6 col-6"><label style="color: black;">N° Documento</label><br><input type="text"  class="form-control" placeholder="N° Documento.." name="formaPago['+conProv+'][for_numero]" required></div></div><br><div class="row"><div class="col-md-12 col-12"><label style="color: black;">Banco</label><br><input type="text"  class="form-control checklife proveedorBanco" placeholder="Banco.." name="proveedor['+conProv+'][pro_banco]" required></div></div><br></div>');
    });*/
